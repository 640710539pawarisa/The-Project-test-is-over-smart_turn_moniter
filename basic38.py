...
#การกร่อนภาพ
erosion = cv2.erode(dilation,kernel,iterations=5)#ใช้ในการกร่อนภาพ, img คือภาพที่เราอ่านมา,erosion เอาไว้เก็บภาพที่กร่อนแล้ว,
#kernel คือ kernel ที่ใช้ในการกร่อนภาพ, 5 คือจํานวนที่ใช้ในการกร่อนภาพ หรือทำซ้ำ 7รอบ

#Opening 
opening = cv2.morphologyEx(dilation, cv2.MORPH_OPEN, kernel, iterations = 7)#ใช้ในการเปิดภาพ ,ตัวนี้จะให้เราระบุค่าเข้าไปทำงาน คือ result คือภาพที่เราอ่านมา
#, cv2.MORPH_OPEN คือการเปิดภาพ, kernel คือ kernel ที่ใช้ในการเปิดภาพ ,interations คือจํานวนที่ใช้ในการเปิดภาพ หรือทำซ้ำ 7รอบ

#closing *****เพิ่มส่วนนี้
closing = cv2.morphologyEx(result, cv2.MORPH_CLOSE, kernel, iterations = 5)#ใช้ในการปิดภาพ ,ตัวนี้จะให้เราระบุค่าเข้าไปทำงาน คือ result คือภาพที่เราอ่านมา

#เพิ่ม***ในส่วนของ closingเข้าไปด้วย 
title = ["ORIGINAL","THRESH","DILATION","EROSION","OPENING","CLOSING"]#ตัวแปร title เก็บชื่อภาพ, "Original" คือชื่อภาพตัวแรก , "Dilation" คือชื่อภาพตัวที่สอง
images = [img,result,dilation,erosion,opening,closing]#เก็บภาพที่ตัวแปร images, img คือภาพที่เราอ่านมา, img_dilation คือภาพที่เราขยายพื้นที่แล้ว
