...
face_cascade = cv2.CascadeClassifier("Detect/haarcascade_frontalface_default.xml")#ตรวจจับใบหน้า ,ให้มันเรียกใช้ไฟล์นี้
...
gray_img = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)#คิอเป็นการแปลงภาพให้เป็นภาพ GrayScale โดยเก็บไว้ในตัวแปร gray_img
