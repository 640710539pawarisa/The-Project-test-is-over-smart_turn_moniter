...
#1.1 คือ ลดขนาดลง 10% , 1.2 คือ ลดขนาดลง 20% , 1.3 คือ ลดขนาดลง 30% ,1.05 คือ ลดขนาดลง 5%******
...
#แสดงตำแหน่งใบหน้าที่ตรวจพบ ,หรือ plot ตำแหน่งที่เจอใบหน้า 
for (x, y, w, h) in face_detected: 
    ...
    cv2.rectangle(img, (x, y), (x+w, y+h), (0, 255, 0), thickness= 2) #ตำแหน่งที่เจอใบหน้าแล้วสร้างกล่องสี่เหลี่ยมล้อมรอบโดยกำหนดสีกล่องเป็นเขียวหนา 2
